...
export const WissenBlack = () => {
    ...
    const flame = () => {
        ...
        flames.to(".outerPathBlack", 0.3, {transformOrigin: "50% 100%",  scale:0.85})
        .to(".outerPathBlack", 0.3, {transformOrigin: "50% 100%",  scale:1})
        .to(".innerPathBlack", 0.3, {transformOrigin: "50% 100%",  scale:1},"-=0.3")
        .to(".innerPathBlack", 0.3, {transformOrigin: "50% 100%",  scale:1.05,  onComplete: flame})

    } 
    flame()

    return (
            <svg id='blackFire' xmlns='http://www.w3.org/2000/svg' width='15.562' height='20.65'
            viewBox='0 0 15.562 20.65'>
                <path className="outerPathBlack" fill='#FBB03B' stroke='#333333' strokeLinecap='round' strokeLinejoin='round'
                ...
                />
                <path className="innerPathBlack" fill='#FFF' stroke='#333333' strokeLinecap='round' strokeLinejoin='round'
